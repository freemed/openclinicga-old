...
<%=checkPermission("financial.reimbursements.edit", "edit", activeUser)%>
<%=sJSPROTOTYPE%>
<%=sJSNUMBER%>
<%
...
<form name='FindForm' id="FindForm" method='POST'>
    ...
    <table class="menu" width="100%">
        <tr>
            <td width="<%=sTDAdminWidth%>"><%=getTran("web.finance", "reimbursement.documentid", sWebLanguage)%>
            </td>
            <td>
...
<table class='list' border='0' width='100%' cellspacing='1'>
    <tr>
        <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran("web", "coverageplan", sWebLanguage)%>
        </td>
        <td class="admin2">
    ...
    <tr id="invoicedetails" style="visibility: hidden">
        <td colspan="2">
            <table class='list' border='0' width='100%' cellspacing='1' id="invoicedetailstable">
                <tr>
                    <td class="admin"><%=getTran("web.finance", "reimbursement.documentid", sWebLanguage)%>
                    </td>
                    <td class="admin2"><input type="text" class="text" readonly name="EditInvoiceUID" id="EditInvoiceUID" value="<%=checkString(coveragePlanInvoice.getInvoiceUid())%>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class='admin'><%=getTran("web", "prestations", sWebLanguage)%>
                    </td>
                    <td class='admin2'>
