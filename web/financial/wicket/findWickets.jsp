        ...
        <tr>
            ...
            <td class='admin2'>
                <select class="text" name="WicketUID">
                    ...
                    %>
                                <option value="<%=wicket.getUid()%>"><%=wicket.getUid()%>&nbsp;<%=getTran("service",wicket.getServiceUID(),sWebLanguage)%></option>
                            <%
                        }
                    %>
                </select>
                <input class='button' type='button' name='buttonfind' value='<%=getTran("Web","view",sWebLanguage)%>' onclick='doFind();'>
