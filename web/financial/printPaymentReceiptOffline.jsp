...
<%
	...
	if(credit!=null && credit.getDate()!=null){
		...
		content+=printer.CENTER+receiptid+" - "+printer.BOLD+ScreenHelper.getTranNoLink("web","receiptforcredit",sWebLanguage).toUpperCase()+" #"+creditnumber+" - "+new SimpleDateFormat("dd/MM/yyyy").format(credit.getDate())+printer.NOTBOLD+printer.LF;
