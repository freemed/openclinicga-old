        ...
        %>
            <table width="100%" class="list" cellspacing="0" style="border:none;">
                ...
                <tr>
                    ...
                    <td class="admin" width="30%"><%=HTMLEntities.htmlentities(getTran("web.finance","encounter",sWebLanguage))%></td>
                    <td class="admin" width="100" align="right"><%=HTMLEntities.htmlentities(getTran("web","amount",sWebLanguage))%>&nbsp;&nbsp;</td>
                    <td class="admin" width="200"><%=HTMLEntities.htmlentities(getTran("web","type",sWebLanguage))%></td>
                    <td class="admin" width="200"><%=HTMLEntities.htmlentities(getTran("web","invoice",sWebLanguage))%></td>
                    <td class="admin" width="*"><%=HTMLEntities.htmlentities(getTran("web","description",sWebLanguage))%></td>
                    <td class="admin" width="*"><%=HTMLEntities.htmlentities(getTran("web","wicket",sWebLanguage))%></td>
                </tr>
