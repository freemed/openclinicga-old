...
<%=
 (
    ...
    +writeTblChild("main.do?Page=system/manageShortcuts.jsp&UserQuickList=1",getTran("Web.UserProfile","ManageShortcuts",sWebLanguage),rowIdx++)
    +writeTblChild("main.do?Page=userprofile/manageUserShortcuts.jsp",getTranNoLink("web.userProfile","manageUserShortcuts",sWebLanguage),rowIdx++)
