                ...
                <%                        
                    ...
                    if(iconsDir.exists() && iconsDir.isDirectory()){ 
                        ...
                        for(int i=0; i<icons.length; i++){
                            ...
                            %><img class="link" id="icon_<%=i%>" src="<%=sCONTEXTPATH%>/_img/<%=icon.getName()%>" onClick="selectIcon(this);" style="border:2px solid white;" filename="<%=icon.getName()%>" title="<%=icon.getName()%>"/>&nbsp;&nbsp;<%
                        }
                    }
                    else{
