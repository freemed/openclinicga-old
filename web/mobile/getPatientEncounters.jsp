...
<table width='100%'>
	<tr><td colspan='3' bgcolor='gray'><b><u><%=getTran("mobile","encounterdata",activeUser) %></u></b></td></tr>
  
    
<%
   Encounter activeContact = Encounter.getActiveEncounter(activePatient.personid);	
    if(activeContact!=null){
    	out.print("<tr><td colspan='3' bgcolor='olive'>"+getTran("openclinic.chuk","rfe",activeUser)+"</td></tr>");
    	...
    	out.print("<tr><td colspan='3' bgcolor='olive'>"+getTran("web","problemlist",activeUser)+"</td></tr>"); 
	    ...
	    out.print("<tr><td colspan='3' bgcolor='olive'>"+getTran("web","managediagnosespatient",activeUser)+"</td></tr>");
