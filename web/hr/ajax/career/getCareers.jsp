    ...
    if(careers.size() > 0){
	    ...
	    for(int i=0; i<careers.size(); i++){
	        ...
	        hSort.put(career.begin.getTime()+"="+career.getUid(),
	                  ...
	                  //"<td class='hand' style='padding-left:5px'>"+getTran("hr.career.grade",career.grade,sWebLanguage)+"</td>"+
	                  //"<td class='hand' style='padding-left:5px'>"+getTran("hr.career.status",career.status,sWebLanguage)+"</td>"+
	                  //"<td class='hand' style='padding-left:5px'>"+getTran("hr.career.status",career.comment,sWebLanguage)+"</td>"+
	                 "</tr>");
	    }
