...
<form name="transactionForm" id="transactionForm" method="post"
      action="<c:url value='/'/>/popup.jsp?Page=medical/managePrescriptionsPopup.jsp&PopupHeight=400&PopupWidth=900" <%=sOnKeyDown%>
      onClick='setSaveButton(event);clearMessage();' onKeyUp='setSaveButton(event);'>
<%-- page title --%>
...
<tr>
    ...
    <td class="admin2">
        <input type="text" maxlength="10" class="text" id="EditDateBegin" name="EditDateBegin" value="<%=sSelectedDateBegin%>" size="12"
               onblur="if(!checkDate(this)){alert('<%=getTran("Web.Occup","date.error",sWebLanguage)%>');this.value='';}else{calculatePackagesNeeded(false);}if(isEndDateBeforeBeginDate()){displayEndBeforeBeginAlert();}"
...
<tr>
    ...
    <td class="admin2">
        <input class="text" type="text" name="EditRequiredPackages" size="5" maxLength="5"
               value="<%=sSelectedRequiredPackages%>" onKeyUp="if(isInteger(this)){calculatePrescriptionPeriod();}">
        &nbsp;(<input type="text" class="text" name="UnitsPerPackage" value="<%=sUnitsPerPackage%>" size="3" readonly
                      style="border:none;background:transparent;text-align:right;">&nbsp;<%=
        getTran("web", "packageunits", sWebLanguage).toLowerCase()%>)
    </td>
</tr>
<%-- prescriber --%>
<tr>
    ...
    <td class="admin2">
        ...
        <input class="text" type="text" name="EditPrescriberFullName" readonly size="<%=sTextWidth%>"
               value="<%=sSelectedPrescriberFullName%>">

        <img src="<c:url value="/_img/icon_search.gif"/>" class="link"
             alt="<%=getTranNoLink("Web","select",sWebLanguage)%>"
             onclick="searchPrescriber('EditPrescriberUid','EditPrescriberFullName');">
        <img src="<c:url value="/_img/icon_delete.gif"/>" class="link"
             alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>"
             onclick="transactionForm.EditPrescriberUid.value='';transactionForm.EditPrescriberFullName.value='';">
    </td>
</tr>
<%-- Service Stock --%>
<tr>
    ...
    <td class="admin2">
        ...
        <input class="text" type="text" name="EditServiceStockName" readonly size="<%=sTextWidth%>"
               value="<%=sSelectedServiceStockName%>">

        <img src="<c:url value="/_img/icon_search.gif"/>" class="link"
             alt="<%=getTranNoLink("Web","select",sWebLanguage)%>"
             onclick="searchServiceStock('EditServiceStockUid','EditServiceStockName');">
        <img src="<c:url value="/_img/icon_delete.gif"/>" class="link"
             alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>"
             onclick="transactionForm.EditServiceStockUid.value='';transactionForm.EditServiceStockName.value='';transactionForm.EditSupplyingServiceUid.value='';transactionForm.EditSupplyingServiceName.value='';">
    </td>
</tr>
<%-- Supplying Service --%>
<tr>
    ...
    <td class="admin2">
        ...
        <input class="text" type="text" name="EditSupplyingServiceName" readonly size="<%=sTextWidth%>"
               value="<%=sSelectedSupplyingServiceName%>">
    </td>
</tr>
<%-- schema --%>
<tr>
    ...
    <td class="admin2">
        <table>
            <tr>
                <td><input class="text" type="text" name="time1"
                           value="<%=prescriptionSchema.getTimeQuantity(0).getKey()%>" size="2"><%=
                    getTran("web", "abbreviation.hour", sWebLanguage)%>
                </td>
                <td><input class="text" type="text" name="time2"
                           value="<%=prescriptionSchema.getTimeQuantity(1).getKey()%>" size="2"><%=
                    getTran("web", "abbreviation.hour", sWebLanguage)%>
                </td>
                <td><input class="text" type="text" name="time3"
                           value="<%=prescriptionSchema.getTimeQuantity(2).getKey()%>" size="2"><%=
                    getTran("web", "abbreviation.hour", sWebLanguage)%>
                </td>
                <td><input class="text" type="text" name="time4"
                           value="<%=prescriptionSchema.getTimeQuantity(3).getKey()%>" size="2"><%=
                    getTran("web", "abbreviation.hour", sWebLanguage)%>
                </td>
                <td><input class="text" type="text" name="time5"
                           value="<%=prescriptionSchema.getTimeQuantity(4).getKey()%>" size="2"><%=
                    getTran("web", "abbreviation.hour", sWebLanguage)%>
                </td>
                <td><input class="text" type="text" name="time6"
                           value="<%=prescriptionSchema.getTimeQuantity(5).getKey()%>" size="2"><%=
                    getTran("web", "abbreviation.hour", sWebLanguage)%>
                </td>
                <td><a href="javascript:loadSchema();"><img class="link" src="<c:url value="/_img/icon_search.gif"/>"
                                                            alt="Search schema"/></a></td>
            </tr>
            <tr>
                <td><input class="text" type="text" name="quantity1"
                           value="<%=prescriptionSchema.getTimeQuantity(0).getValue()%>" size="2">#
                </td>
                <td><input class="text" type="text" name="quantity2"
                           value="<%=prescriptionSchema.getTimeQuantity(1).getValue()%>" size="2">#
                </td>
                <td><input class="text" type="text" name="quantity3"
                           value="<%=prescriptionSchema.getTimeQuantity(2).getValue()%>" size="2">#
                </td>
                <td><input class="text" type="text" name="quantity4"
                           value="<%=prescriptionSchema.getTimeQuantity(3).getValue()%>" size="2">#
                </td>
                <td><input class="text" type="text" name="quantity5"
                           value="<%=prescriptionSchema.getTimeQuantity(4).getValue()%>" size="2">#
                </td>
                <td><input class="text" type="text" name="quantity6"
                           value="<%=prescriptionSchema.getTimeQuantity(5).getValue()%>" size="2">#
                </td>
                <td/>
            </tr>
        </table>
...
%>
<input class="button" type="button" name="saveButton" id="saveButton"
       value='<%=getTranNoLink("Web","save",sWebLanguage)%>' onclick="doSave();">
<%
    }

    if ((prescr == null || (prescr != null && prescr.getDeliveredQuantity() == 0)) && activeUser.getAccessRight("prescriptions.drugs.delete")) {
%>
<input class="button" type="button" name="deleteButton" value='<%=getTranNoLink("Web","delete",sWebLanguage)%>'
       onclick="doDelete('<%=sEditPrescrUid%>');">
<%
    }

%>
<input class="button" type="button" name="returnButton" value='<%=getTranNoLink("Web","backtooverview",sWebLanguage)%>'
...
%>
<input class="button" type="button" name="returnButton" value='<%=getTranNoLink("Web","back",sWebLanguage)%>'
       onclick="doBack();">
<%
    }
%>
