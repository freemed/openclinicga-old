			    ...
			    <table class="list">
			        <%
			            ...
			            for(int n=0;n<requestList.size();n++){
			                ...
			                out.print("<tr>"+
			                           "<td class='text'>"+
			                            "<input type='checkbox' "+(n<5?"checked":"")+" name='show."+labRequest.getServerid()+"."+labRequest.getTransactionid()+"'/>"+ScreenHelper.fullDateFormat.format(labRequest.getRequestdate())+
			                           "</td>"+
			                          "</tr>");
			            }
			        %>
