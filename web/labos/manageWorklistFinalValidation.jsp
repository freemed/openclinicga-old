<%@ page import="be.openclinic.medical.ResultsProfile,java.util.*,be.openclinic.medical.LabRequest,be.openclinic.medical.RequestedLabAnalysis,be.openclinic.medical.LabAnalysis" %>
...
<%
    if (!activeProfile.equalsIgnoreCase("")) {
        ...
        <%
            ...
            //Here we will generate all configured alertvalues
