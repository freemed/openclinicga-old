...
<%!
    private StringBuffer addSignesVitaux(int iTotal,String sHeure,String sSys,String sDias,String sRythme,String sTemp, String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td>" +
            " <a href='javascript:deleteSignesVitaux(rowSignesVitaux"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_delete.gif' alt='" + getTran("Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
            " <a href='javascript:editSignesVitaux(rowSignesVitaux"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_edit.gif' alt='" + getTran("Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
            "</td>" +
            "<td>" + sHeure + "</td>" +
            "<td>" +sSys +"</td>" +
            "<td>" +sDias +"</td>" +
    ...
    private StringBuffer addSignesVitauxResp(int iTotal,String sHeure,String sResp,String sAmbient,String sUnder,String sVolume, String sMode, String sObservation,String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td>" +
            " <a href='javascript:deleteSignesVitauxResp(rowSignesVitauxResp"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_delete.gif' alt='" + getTran("Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
            " <a href='javascript:editSignesVitauxResp(rowSignesVitauxResp"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_edit.gif' alt='" + getTran("Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
            "</td>" +
            "<td>" + sHeure + "</td>" +
            "<td>" +sResp +"</td>" +
            "<td>" +sAmbient +"</td>" +
    ...
    private StringBuffer addConscience(int iTotal,String sHeure,String sYeux,String sMotrice,String sVerbale,String sTotal, String sPain,String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td>" +
            " <a href='javascript:deleteConscience(rowConscience"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_delete.gif' alt='" + getTran("Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
            " <a href='javascript:editConscience(rowConscience"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_edit.gif' alt='" + getTran("Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
            "</td>" +
            "<td>&nbsp;" + sHeure + "</td>" +
            "<td>&nbsp;" + sYeux + "</td>" +
            "<td>&nbsp;" + sMotrice + "</td>" +
    ...
    private StringBuffer addBiometrie(int iTotal,String sHeure,String sPoids,String sTaille,String sBMI,String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td>" +
            " <a href='javascript:deleteBiometrie(rowBiometrie"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_delete.gif' alt='" + getTran("Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
            " <a href='javascript:editBiometrie(rowBiometrie"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_edit.gif' alt='" + getTran("Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
            "</td>" +
            "<td>&nbsp;" + sHeure + "</td>" +
            "<td>&nbsp;" + sPoids + "</td>" +
            "<td>&nbsp;" + sTaille + "</td>" +
    ...
    private StringBuffer addBilanEntree(int iTotal,String sHeure,String sLactate,String sGlucose,String sPhysio,String sHaem,String sTrans, String sSang,String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td>" +
            "<a href='javascript:deleteBilanEntree(rowBilanEntree"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_delete.gif' alt='" + getTran("Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
            "<a href='javascript:editBilanEntree(rowBilanEntree"+iTotal+")'><img src='" + sCONTEXTPATH + "/_img/icon_edit.gif' alt='" + getTran("Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
            "</td>" +
            "<td>&nbsp;" +sHeure +"</td>" +
            "<td>&nbsp;" +sLactate +"</td>" +
            "<td>&nbsp;" +sGlucose +"</td>" +
    ...
    private StringBuffer addSitNutri(int iTotal,String sHeure,String sLait,String sBouillie,String sPotage, String sJuice, String sWater,String sPB,String sPT, String sIMC,String sObservation,String sWebLanguage){
        ...
        sTmp.append(
            ...
            "<td width='40'>" +
            "<a href='javascript:deleteSitNutri(rowSitNutri"+iTotal+");'><img src='" + sCONTEXTPATH + "/_img/icon_delete.gif' alt='" + getTran("Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
            "<a href='javascript:editSitNutri(rowSitNutri"+iTotal+");'><img src='" + sCONTEXTPATH + "/_img/icon_edit.gif' alt='" + getTran("Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
            "</td>"+
                            ...
                            <%
                                ...
                                for (int i = 0; i < vTransactions.size(); i++) {
                                    ...
                                    if ((activeEncounter != null) && (transactionVO != null)
                                            && (!transactionVO.getUpdateTime().before(new SimpleDateFormat("dd/MM/yyyy").parse(new SimpleDateFormat("dd/MM/yyyy").format(activeEncounter.getBegin()))))
                                            && ((activeEncounter.getEnd() == null)
                                            || (!transactionVO.getUpdateTime().after(new SimpleDateFormat("dd/MM/yyyy").parse(new SimpleDateFormat("dd/MM/yyyy").format(activeEncounter.getEnd())))))) {
                                        ...
                                        out.print("<td width='100'>" + new SimpleDateFormat("dd/MM/yyyy").format(transactionVO.getCreationDate()) + "</td>");
                                    }
                                }
                            %>
                        <td/>
...
function addSignesVitaux(){
  if(isAtLeastOneSignesVitauxFieldFilled()){
      ...
      td.innerHTML = "<a href='javascript:deleteSignesVitaux(rowSignesVitaux"+iSignesVitauxIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editSignesVitaux(rowSignesVitaux"+iSignesVitauxIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateSignesVitaux(){
  if(isAtLeastOneSignesVitauxFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteSignesVitaux("+editSignesVitauxRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editSignesVitaux("+editSignesVitauxRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addSignesVitauxResp(){
  if(isAtLeastOneSignesVitauxRespFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteSignesVitauxResp(rowSignesVitauxResp"+iSignesVitauxRespIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editSignesVitauxResp(rowSignesVitauxResp"+iSignesVitauxRespIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateSignesVitauxResp(){
  if(isAtLeastOneSignesVitauxRespFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteSignesVitauxResp("+editSignesVitauxRespRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editSignesVitauxResp("+editSignesVitauxRespRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addConscience(){
  if(isAtLeastOneConscienceFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteConscience(rowConscience"+iConscienceIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editConscience(rowConscience"+iConscienceIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateConscience(){
  if(isAtLeastOneConscienceFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteConscience("+editConscienceRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editConscience("+editConscienceRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addBiometrie(){
  if(isAtLeastOneBiometrieFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteBiometrie(rowBiometrie"+iBiometrieIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editBiometrie(rowBiometrie"+iBiometrieIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateBiometrie(){
  if(isAtLeastOneBiometrieFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteBiometrie("+editBiometrieRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editBiometrie("+editBiometrieRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addBilanEntree(){
  if(isAtLeastOneBilanEntreeFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteBilanEntree(rowBilanEntree"+iBilanEntreeIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editBilanEntree(rowBilanEntree"+iBilanEntreeIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateBilanEntree(){
  if(isAtLeastOneBilanEntreeFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteBilanEntree("+editBilanEntreeRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editBilanEntree("+editBilanEntreeRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function addSitNutri(){
  if(isAtLeastOneSitNutriFieldFilled()){
      ...
      var td = tr.insertCell(0);
      td.innerHTML = "<a href='javascript:deleteSitNutri(rowSitNutri"+iSitNutriIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='javascript:editSitNutri(rowSitNutri"+iSitNutriIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateSitNutri(){
  if(isAtLeastOneSitNutriFieldFilled()){
    ...
    row.cells[0].innerHTML = "<a href='javascript:deleteSitNutri(rowSitNutri"+iSitNutriIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='javascript:editSitNutri(rowSitNutri"+iSitNutriIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function submitForm() {
  ...
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_1" property="itemId"/>]>.value"].value = sSignesVitaux.substring(0,254);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_2" property="itemId"/>]>.value"].value = sSignesVitaux.substring(254,508);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_3" property="itemId"/>]>.value"].value = sSignesVitaux.substring(508,762);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_4" property="itemId"/>]>.value"].value = sSignesVitaux.substring(762,1016);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_5" property="itemId"/>]>.value"].value = sSignesVitaux.substring(1016,1270);

  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_RESP_1" property="itemId"/>]>.value"].value = sSignesVitauxResp.substring(0,254);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_RESP_2" property="itemId"/>]>.value"].value = sSignesVitauxResp.substring(254,508);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_RESP_3" property="itemId"/>]>.value"].value = sSignesVitauxResp.substring(508,762);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_RESP_4" property="itemId"/>]>.value"].value = sSignesVitauxResp.substring(762,1016);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SIGN_VITAUX_RESP_5" property="itemId"/>]>.value"].value = sSignesVitauxResp.substring(1016,1270);

  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_CONSCIENCE_1" property="itemId"/>]>.value"].value = sConscience.substring(0,254);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_CONSCIENCE_2" property="itemId"/>]>.value"].value = sConscience.substring(254,508);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_CONSCIENCE_3" property="itemId"/>]>.value"].value = sConscience.substring(508,762);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_CONSCIENCE_4" property="itemId"/>]>.value"].value = sConscience.substring(762,1016);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_CONSCIENCE_5" property="itemId"/>]>.value"].value = sConscience.substring(1016,1270);

  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BIOMETRIE_1" property="itemId"/>]>.value"].value = sBiometrie.substring(0,254);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BIOMETRIE_2" property="itemId"/>]>.value"].value = sBiometrie.substring(254,508);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BIOMETRIE_3" property="itemId"/>]>.value"].value = sBiometrie.substring(508,762);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BIOMETRIE_4" property="itemId"/>]>.value"].value = sBiometrie.substring(762,1016);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BIOMETRIE_5" property="itemId"/>]>.value"].value = sBiometrie.substring(1016,1270);

  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANENTREE_1" property="itemId"/>]>.value"].value = sBilanEntree.substring(0,254);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANENTREE_2" property="itemId"/>]>.value"].value = sBilanEntree.substring(254,508);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANENTREE_3" property="itemId"/>]>.value"].value = sBilanEntree.substring(508,762);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANENTREE_4" property="itemId"/>]>.value"].value = sBilanEntree.substring(762,1016);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_BILANENTREE_5" property="itemId"/>]>.value"].value = sBilanEntree.substring(1016,1270);

  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_1" property="itemId"/>]>.value"].value = sSitNutri.substring(0,254);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_2" property="itemId"/>]>.value"].value = sSitNutri.substring(254,508);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_3" property="itemId"/>]>.value"].value = sSitNutri.substring(508,762);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_4" property="itemId"/>]>.value"].value = sSitNutri.substring(762,1016);
  document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_PROTSURV_SITUATION_NUTRITIONAL_5" property="itemId"/>]>.value"].value = sSitNutri.substring(1016,1270);
