            ...
            <table class="list" width="100%" cellspacing="0">
                ...
                <logic:present name="be.mxs.webapp.wl.session.SessionContainerFactory.WO_SESSION_CONTAINER" property="riskCodesVO">
                    <logic:iterate id="riskProfileRiskCode" scope="session" name="be.mxs.webapp.wl.session.SessionContainerFactory.WO_SESSION_CONTAINER" property="riskCodesVO">
                        <tr>
                            <td valign="top"><mxs:propertyAccessorI18N name="riskProfileRiskCode.riskCodeVO" scope="page" property="label" translate="false"/></td>
                            <td valign="top"><mxs:propertyAccessorI18N name="riskProfileRiskCode.riskProfileRiskCodeVO" scope="page" property="code" translate="false"/></td>
                            <td valign="top"><mxs:propertyAccessorI18N name="riskProfileRiskCode.riskProfileRiskCodeVO" scope="page" property="type"/></td>
                            <td valign="top"><mxs:propertyAccessorI18N name="riskProfileRiskCode.riskProfileRiskCodeVO" scope="page" property="statusMessageKey"/></td>
                        </tr>
                    </logic:iterate>
                </logic:present>
            </table>
