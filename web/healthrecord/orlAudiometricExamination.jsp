...
dR125 = new Dot(D.ScreenX(0),D.ScreenY(document.getElementsByName('R125')[0].value),8,6,"ff0000","");
dR25 = new Dot(D.ScreenX(1),D.ScreenY(document.getElementsByName('R25')[0].value),8,6,"ff0000","");
dR50 = new Dot(D.ScreenX(2),D.ScreenY(document.getElementsByName('R50')[0].value),8,6,"ff0000","");
dR1 = new Dot(D.ScreenX(3),D.ScreenY(document.getElementsByName('R1')[0].value),8,6,"ff0000","");
dR2 = new Dot(D.ScreenX(4),D.ScreenY(document.getElementsByName('R2')[0].value),8,6,"ff0000","");
dR4 = new Dot(D.ScreenX(5),D.ScreenY(document.getElementsByName('R4')[0].value),8,6,"ff0000","");
dR8 = new Dot(D.ScreenX(6),D.ScreenY(document.getElementsByName('R8')[0].value),8,6,"ff0000","");
...
dL125 = new Dot(D.ScreenX(0),D.ScreenY(document.getElementsByName('L125')[0].value),8,1,"0000ff","");
dL25 = new Dot(D.ScreenX(1),D.ScreenY(document.getElementsByName('L25')[0].value),8,1,"0000ff","");
dL50 = new Dot(D.ScreenX(2),D.ScreenY(document.getElementsByName('L50')[0].value),8,1,"0000ff","");
dL1 = new Dot(D.ScreenX(3),D.ScreenY(document.getElementsByName('L1')[0].value),8,1,"0000ff","");
dL2 = new Dot(D.ScreenX(4),D.ScreenY(document.getElementsByName('L2')[0].value),8,1,"0000ff","");
dL4 = new Dot(D.ScreenX(5),D.ScreenY(document.getElementsByName('L4')[0].value),8,1,"0000ff","");
dL8 = new Dot(D.ScreenX(6),D.ScreenY(document.getElementsByName('L8')[0].value),8,1,"0000ff","");
...
dRBONY125 = new Dot(D.ScreenX(0),D.ScreenY(document.getElementsByName('RBONY125')[0].value),8,6,"000000","");
dRBONY25 = new Dot(D.ScreenX(1),D.ScreenY(document.getElementsByName('RBONY25')[0].value),8,6,"000000","");
dRBONY50 = new Dot(D.ScreenX(2),D.ScreenY(document.getElementsByName('RBONY50')[0].value),8,6,"000000","");
dRBONY1 = new Dot(D.ScreenX(3),D.ScreenY(document.getElementsByName('RBONY1')[0].value),8,6,"000000","");
dRBONY2 = new Dot(D.ScreenX(4),D.ScreenY(document.getElementsByName('RBONY2')[0].value),8,6,"000000","");
dRBONY4 = new Dot(D.ScreenX(5),D.ScreenY(document.getElementsByName('RBONY4')[0].value),8,6,"000000","");
dRBONY8 = new Dot(D.ScreenX(6),D.ScreenY(document.getElementsByName('RBONY8')[0].value),8,6,"000000","");
...
dLBONY125 = new Dot(D.ScreenX(0),D.ScreenY(document.getElementsByName('LBONY125')[0].value),8,1,"800080","");
dLBONY25 = new Dot(D.ScreenX(1),D.ScreenY(document.getElementsByName('LBONY25')[0].value),8,1,"800080","");
dLBONY50 = new Dot(D.ScreenX(2),D.ScreenY(document.getElementsByName('LBONY50')[0].value),8,1,"800080","");
dLBONY1 = new Dot(D.ScreenX(3),D.ScreenY(document.getElementsByName('LBONY1')[0].value),8,1,"800080","");
dLBONY2 = new Dot(D.ScreenX(4),D.ScreenY(document.getElementsByName('LBONY2')[0].value),8,1,"800080","");
dLBONY4 = new Dot(D.ScreenX(5),D.ScreenY(document.getElementsByName('LBONY4')[0].value),8,1,"800080","");
dLBONY8 = new Dot(D.ScreenX(6),D.ScreenY(document.getElementsByName('LBONY8')[0].value),8,1,"800080","");

////////////////////////////////////////////////////////////////////////////

var H = new Diagram();
H.SetFrame(510,250,670,335);
H.XScale="";
H.YScale="1";
