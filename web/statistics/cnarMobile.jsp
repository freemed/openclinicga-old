...
%>
	<br/><hr/><br/>
	<table width="100%">
		<tr class='admin'><td colspan='6'><%=getTran("cnar","statistics.mob.title1",sWebLanguage) %></td></tr>
		<tr class='admin'>
...
%>
	<br/><hr/><br/>
	<table width="100%">
		<tr class='admin'><td colspan='8'><%=getTran("cnar","statistics.mob.title2",sWebLanguage) %></td></tr>
		<tr class='admin'>
			<td rowspan='2'><%=getTran("cnar","statistics.prestation.name",sWebLanguage) %></td>
