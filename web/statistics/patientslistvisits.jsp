...
<%
    ...
    String sql = "select firstname,lastname,dateofbirth,oc_encounter_begindate,oc_encounter_serviceuid,oc_encounter_objectid,personid,(select max(oc_insurance_insuraruid)"+
