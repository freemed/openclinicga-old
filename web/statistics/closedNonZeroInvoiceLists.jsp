...
<table width="100%">
<tr><td class='admin' colspan="6"><%=getTran("Web","statistics.closednonzeroinvoicelists",sWebLanguage) %></td></tr>
<%
	String activeuser="";
	Vector invoices=PatientInvoice.searchInvoicesByStatusAndBalance(request.getParameter("start"),request.getParameter("end"),"closed","1");
