...
<%
	...
	%>
	<table width="100%">
		<tr class='admin'><td colspan='2'><%=getTran("cnar","statistics.ortho.title1",sWebLanguage)%></td></tr>
		<tr>
...
%>
	<br/><hr/><br/>
	<table width="100%">
		<tr class='admin'><td colspan='3'><%=getTran("cnar","statistics.ortho.title2",sWebLanguage)%></td></tr>
		<tr class='admin'>
			<td rowspan="2"><%=getTran("cnar","statistics.prestation.name",sWebLanguage)%></td>
...
%>
	<br/><hr/><br/>
	<table width="100%">
		<tr class='admin'><td colspan='6'><%=getTran("cnar","statistics.ortho.title3",sWebLanguage)%></td></tr>
		<tr class='admin'>
			<td rowspan='2'><%=getTran("cnar","statistics.prestation.name",sWebLanguage)%></td>
...
%>
	<br/><hr/><br/>
	<table width="100%">
		<tr class='admin'><td colspan='8'><%=getTran("cnar","statistics.ortho.title4",sWebLanguage)%></td></tr>
		<tr class='admin'>
			<td rowspan='2'><%=getTran("cnar","statistics.prestation.name",sWebLanguage)%></td>
...
%>
	<br/><hr/><br/>
	<table width="100%">
		<tr class='admin'><td colspan='2'><%=getTran("cnar","statistics.ortho.title5",sWebLanguage)%></td></tr>
		<tr>
			<td class='admin'><%= getTran("web","total",sWebLanguage)%></td>
			<td class='admin'><%= total %></td>
		</tr>
