...
Ajax.Responders.register({
 ...
 onComplete: function(){
 if('function'==typeof(setHighlightBtns)){
 setHighlightBtns();
 }
 Ajax.activeRequestCount--;
 }
...
Element.addMethods();
document.write('<script src="_common/_script/scriptaculous/scriptaculous.js"></script>');
...
ClientMsg.prototype = {
 ...
 setValidTemp:function(msg, time){
 if(!time) time = 3000;
 $(this.div).update(msg);
