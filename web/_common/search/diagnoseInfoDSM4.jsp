  ...
  function doAdd(){
    ...
    if(certainty.length == 0){
        ...
        if("<%=sType%>" == "DSM4"){
            ...
            if(document.all['alternativeCode']) varOpener.document.getElementById('<%=sReturnField%>').innerHTML+= "<span id='DSM4"+document.all['alternativeCode'].value+"'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' onclick='document.getElementById(\"DSM4"+document.all['alternativeCode'].value+"\").innerHTML=\"\";'/> <input type='hidden' name='DSM4Code"+document.all['alternativeCode'].value+"' value=\"<%=sValue%>  "  + "\"/><input type='hidden' name='GravityDSM4Code"+document.all['alternativeCode'].value+"' value=\"" + gravity + "\"/><input type='hidden' name='CertaintyDSM4Code"+document.all['alternativeCode'].value+"' value=\"" + certainty + "\"/><input type='hidden' name='POADSM4Code"+document.all['alternativeCode'].value+"' value=\"" + POA + "\"/><input type='hidden' name='ServiceDSM4Code"+document.all['alternativeCode'].value+"' value=\"" + serviceUid + "\"/><input type='hidden' name='FlagsDSM4Code"+document.all['alternativeCode'].value+"' value=\"" + flags + "\"/><i><b>DSM4</b></i> "+document.all['alternativeCode'].value+"&nbsp;"+document.all['alternativeCodeLabel'].value+"&nbsp;<%=sValue%>  " + varAddon + " "+POAComment+ " "+NCComment+ " " + flags+"<br/></span>";
        }
