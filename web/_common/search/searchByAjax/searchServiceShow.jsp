        ...
        if (service!=null){
            ...
            if (isactive){
                ...
                if (sIcon.length() == 0 && MedwanQuery.getInstance().existSubServices(sID)) {
                    sIcon = "<img src='" + sCONTEXTPATH + "/_img/menu_tee_plus.gif' onclick='populateService(\"" + sID + "\")' alt='" + getTran("Web.Occup", "medwan.common.open", sWebLanguage) + "'>";
                }

                row += "<tr>" +
                        " <td>" + sIcon + "</td><td><img src='" + sCONTEXTPATH + "/_img/icon_view.gif' alt='" + getTran("Web", "view", sWebLanguage) + "' onclick='viewService(\"" + sID + "\")'></td>" +
                ...
                if (sLabel.indexOf("<a") > -1) {
                    ...
                    row += "<td class='"+sClass+"'>" + (hasBeds && acceptsvisits ? "<a href='#' onclick='selectParentService(\"" + sID + "\",\"" + sLabel + "\")' title='" + getTran("Web", "select", sWebLanguage) + "'>" : "") + sLabel + (hasBeds && acceptsvisits? "</a>" : "") + "</td>";
                }
...
<%
    ...
    if (Debug.enabled) Debug.println("*** searchService : searchInternalServices : " + searchInternalServices);
    ...
    if (Debug.enabled) Debug.println("*** searchService : searchExternalServices : " + searchExternalServices);
...
<table width="100%" cellspacing="1">
    ...
    <tr>
        <td colspan="2" align="right">
            <input type="button" class="button" value="<%=getTran("Web","select",sWebLanguage)%>"
