...
//              +inputRow("Web","district","PDistrict","AdminPrivate",apc.district,"T",true,false,sWebLanguage)
              +"<tr><td class='admin'>"+getTran("web","state",sWebLanguage)+"</td><td class='admin2'>"+sDistricts+"</td></tr>"
//              +inputRow("Web","city","PCity","AdminPrivate",apc.city,"T",true, true,sWebLanguage)
              +"<tr><td class='admin'>"+getTran("web","microregion",sWebLanguage)+"</td><td class='admin2'>"+sCities+"</td></tr>"
