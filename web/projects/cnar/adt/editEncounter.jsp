...
%>
    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
        ...
        <tr>
            ...
            <td class="admin2">
                <select class="text" name="EditEncounterOriginCNAR1" id="EditEncounterOriginCNAR1" onchange="loadSelect('cnar.origin.'+this.options[this.selectedIndex].value,document.getElementById('EditEncounterOriginCNAR2'))">
                    <option/>
                    <%
                        out.print(ScreenHelper.writeSelect("urgency.origin",sEditEncounterOriginCNAR1,sWebLanguage));
                    %>
                </select>
                <select class='text' name='EditEncounterOriginCNAR2' id='EditEncounterOriginCNAR2'>
                    <%
                        out.print(ScreenHelper.writeSelect("cnar.origin."+sEditEncounterOriginCNAR1,sEditEncounterOriginCNAR2,sWebLanguage));
                    %>
                </select>
        ...
        <%-- origin comment --%>
        <tr>
            <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran("Web","origin.details",sWebLanguage)%></td>
            <td class="admin2">
        ...
        <tr>
            ...
            <td class="admin2">
                <select class='text' name='EditEncounterOriginCNAR3' id='EditEncounterOriginCNAR3'>
                    <option/>
                    <%
                        out.print(ScreenHelper.writeSelect("encounter.socialservice.manager",sEditEncounterOriginCNAR3,sWebLanguage));
                    %>
                </select>
            </td>
        </tr>
       ...
       <tr id="Service">
        ...
        <tr>
            ...
            <td class="admin2">
                <select class='text' name='EditEncounterOriginCNAR4' id='EditEncounterOriginCNAR4'>
                    <option/>
                    <%
                        out.print(ScreenHelper.writeSelect("encounter.manager",sEditEncounterOriginCNAR4,sWebLanguage));
                    %>
                </select>
            </td>
        </tr>
       ...
       <tr id="transfer" style="visibility:visible;">
        ...
        <tr id="Bed" style="visibility:visible;">
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value="/_img/icon_search.gif"/>" id="SearchBedButton" class="link" alt="<%=getTran("Web","select",sWebLanguage)%>" onclick="searchDestination('EditEncounterBed','EditEncounterBedName','<%=MedwanQuery.getInstance().getConfigString("defaultBedsServiceID","")%>');">
        ...
        <tr>
            ...
            <td class="admin2">
                <select class="text" name="EditEncounterOutcome" style="vertical-align:top;">
                    ...
                    <%=ScreenHelper.writeSelect("encounter.outcome",sEditEncounterOutcome,sWebLanguage)%>
                </select>
            </td>
        </tr>
        <tr id="Destination" style="visibility: visible;">
            ...
            <td class='admin2'>
                <select class="text" name="EditEncounterOriginCNAR5" id="EditEncounterOriginCNAR5" onchange="loadSelect('cnar.destination.'+this.options[this.selectedIndex].value,document.getElementById('EditEncounterOriginCNAR6'))">
                    <option/>
                    <%
                        out.print(ScreenHelper.writeSelect("encounter.destination",sEditEncounterOriginCNAR5,sWebLanguage));
                    %>
                </select>
                <select class='text' name='EditEncounterOriginCNAR6' id='EditEncounterOriginCNAR6'>
                    <%
                        out.print(ScreenHelper.writeSelect("cnar.destination."+sEditEncounterOriginCNAR5,sEditEncounterOriginCNAR6,sWebLanguage));
                    %>
                </select>
            </td>
        </tr>
        <tr>
            <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran("Web","destination.details",sWebLanguage)%></td>
            <td class="admin2">
