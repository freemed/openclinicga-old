...
<form name="EditInsuranceForm" id="EditInsuranceForm" method="POST" action="<c:url value='/main.do'/>?Page=financial/insurance/editInsurance.jsp&ts=<%=getTs()%>">
    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
        <%-- company --%>
            <tr>
                <td class="admin">
                    <%=getTran("web","company.class",sWebLanguage)%>
                </td>
                <td class="admin2">
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <img id="img1" src="<c:url value="/_img/icon_search.gif"/>" class="link" alt="<%=getTran("Web","select",sWebLanguage)%>" onclick="searchAffiliate();">
                <img id="img2" src="<c:url value="/_img/icon_delete.gif"/>" class="link" alt="<%=getTran("Web","clear",sWebLanguage)%>" onclick="EditInsuranceForm.EditInsuranceMemberName.value='';EditInsuranceForm.EditInsuranceMember.value='';EditInsuranceForm.EditInsuranceMemberEmployer.value='';EditInsuranceForm.EditInsuranceMemberImmat.value='';">
            </td>
        </tr>
        <tr>
            <td class="admin" width="<%=sTDAdminWidth%>">
                <%=getTran("insurance","membernumber",sWebLanguage)%>
            </td>
            <td class="admin2">
