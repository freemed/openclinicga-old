        ...
        <tr>
            <td>
                <%
                    ...
                    hMenu.put(getTran("Web.Manage", "contributions", sWebLanguage), "main.do?Page=system/manageContributions.jsp");
                    ...
                    hMenu.put(getTran("Web.Manage", "ManageCoveragePlans", sWebLanguage), "main.do?Page=system/manageCoveragePlans.jsp");
