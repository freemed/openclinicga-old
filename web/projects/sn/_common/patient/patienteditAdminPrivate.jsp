...
//            sBeginDate+= "&nbsp;<input type='button' name='buttonNewAPC' class='button' onclick='newAPC()' value='"+getTranNoLink("Web","new",sWebLanguage)+"'>";
        ...
        out.print(sBeginDate
              ...
              +"<tr><td class='admin'>"+getTran("web","country.department",sWebLanguage)+"</td><td class='admin2'>"+sDistricts+"</td></tr>"
              +"<tr><td class='admin'>"+getTran("web","arrondissement",sWebLanguage)+"</td><td class='admin2'>"+sCities+"</td></tr>"
