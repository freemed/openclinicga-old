                ...
                <%
                    if (tmpEncounter != null) {
                        ...
                        if(encounterService!=null && encounterService.end==null){
                            ...
                            %><tr><td><img src="<c:url value="/_img/icons/icon_delete.gif"/>" class="link" alt="<%=getTran("Web","delete",sWebLanguage)%>" onclick="deleteService('<%=encounterService.serviceUID%>')"></td>
