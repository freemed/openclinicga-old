...
<%
    ...
    /// DEBUG /////////////////////////////////////////////////////////////////////////////////////
    if(Debug.enabled){
    	Debug.println("\n************************ adt/editEncounter.jsp ************************");
    	Debug.println("sEditEncounterUID        : "+sEditEncounterUID);
    	Debug.println("sEditEncounterType       : "+sEditEncounterType);
    	Debug.println("sEditEncounterBegin      : "+sEditEncounterBegin);
    	Debug.println("sEditEncounterBeginHour  : "+sEditEncounterBeginHour);
    	Debug.println("sEditEncounterEnd        : "+sEditEncounterEnd);
    	Debug.println("sEditEncounterEndHour    : "+sEditEncounterEndHour);
    	Debug.println("sEditEncounterCategories : "+sEditEncounterCategories+"\n");
    }
    ///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    String sEditEncounterDestination     = checkString(request.getParameter("EditEncounterDestination")),
           sEditEncounterDestinationName = checkString(request.getParameter("EditEncounterDestinationName"));

    String sEditEncounterBed     = checkString(request.getParameter("EditEncounterBed")),
           sEditEncounterBedName = checkString(request.getParameter("EditEncounterBedName"));

    String sEditEncounterPatient     = checkString(request.getParameter("EditEncounterPatient")),
           sEditEncounterPatientName = checkString(request.getParameter("EditEncounterPatientName"));
    ...
    if(sAction.equals("SAVE")){
        ...
        %><script>window.location.href = "<c:url value='/main.do'/>?Page=curative/index.jsp&ts=<%=getTs()%>";</script><%
    }
    
    String sRfe = "", sMaxTransferDate = "";
    if(sEditEncounterUID.length() > 0){
    ...
    <table class='list' border='0' width='100%' cellspacing='1'>
        ...
        <tr>
            ...
            <td class="admin2">
                ...
                <img src="<c:url value='/_img/icons/icon_search.gif'/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchManager('EditEncounterManager','EditEncounterManagerName');">
                <img src="<c:url value='/_img/icons/icon_delete.gif'/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditEncounterForm.EditEncounterManager.value='';EditEncounterForm.EditEncounterManagerName.value='';">
            </td>
        </tr>
        ...
        <tr id="Bed" style="visibility:visible;">
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value='/_img/icons/icon_search.gif'/>" id="SearchBedButton" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchBed('EditEncounterBed','EditEncounterBedName');">
                <img src="<c:url value='/_img/icons/icon_delete.gif'/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditEncounterForm.EditEncounterBed.value='';EditEncounterForm.EditEncounterBedName.value='';">
            </td>
        </tr>
        ...
        <tr id="Destination" style="visibility:visible;">
            ...
            <td class='admin2'>
                ...
                <img src="<c:url value='/_img/icons/icon_search.gif'/>" class="link" alt="<%=getTranNoLink("Web","select",sWebLanguage)%>" onclick="searchService('EditEncounterDestination','EditEncounterDestinationName');">
                <img src="<c:url value='/_img/icons/icon_delete.gif'/>" class="link" alt="<%=getTranNoLink("Web","clear",sWebLanguage)%>" onclick="EditEncounterForm.EditEncounterDestination.value='';EditEncounterForm.EditEncounterDestinationName.value='';">
            </td>
        </tr>
              ...
              <script>
                ...
                if(yesnoDialog("adt.encounter","encounter_close")){
                  window.location.href = "<c:url value='main.do'/>?Page=adt/editEncounter.jsp"+
                   		                 "&EditEncounterUID=<%=activeEncounter.getUid()%>";
                }
                else{
                  history.back();
                }
...
<script>
  ...
  function checkDates(){
    if(EditEncounterForm.EditEncounterEnd.value==""){
      ...
      var end   = ParseDate(EditEncounterForm.EditEncounterEnd.value),
          begin = ParseDate(EditEncounterForm.EditEncounterBegin.value);
  ...
  function calculateAccomodationDates(){
    if(EditEncounterForm.EditEncounterEnd.value.length>0 &&
       EditEncounterForm.EditEncounterEndHour.value.length==0){
  ...
  function deleteService(sID){
    if(yesnoDialog("Web","areYouSureToDelete")){
      var url = '<c:url value="/adt/ajaxActions/editEncounterDeleteService.jsp"/>?EncounterUID=<%=sEditEncounterUID%>&ServiceUID='+sID+'&ts='+new Date();
      document.getElementById('divServices').innerHTML = "<img src='<%=sCONTEXTPATH%>/_img/themes/<%=sUserTheme%>/ajax-loader.gif'/><br/>Loading";
  ...
  function changeService(){
    var url = '<c:url value="/adt/findServiceStayPrestation.jsp"/>?serviceid='+document.getElementById('EditEncounterService').value+'&ts='+new Date();
    new Ajax.Request(url,{
      method: "POST",
      parameters: "",
      onSuccess: function(resp){
