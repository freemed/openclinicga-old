...
<table width="100%" align="center" class='sortable' cellspacing="0">
    ...
    <%Iterator it = lnutricientsitems.iterator();
        ...
        while (it.hasNext()) {
            ...
            out.write("<tr onclick='insertNutricientItem(\"" + item.getUid() + "\",\"" + HTMLEntities.htmlQuotes(HTMLEntities.htmlentities(item.name)) + "\",\"" + HTMLEntities.htmlQuotes(HTMLEntities.htmlentities(item.unit)) + "\")' onmouseover=\"this.className='list_select hand';\" onmouseout=\"this.className='" + sClass + "';\" class='" + sClass + "' >");
