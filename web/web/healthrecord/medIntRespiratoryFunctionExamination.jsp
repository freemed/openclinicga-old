...
%>
    ...
    <table class="list" width="100%" cellspacing="1">
		<tr>
			<td colspan="2" valign="top" class="admin2">
			    <table class="list" width="100%" cellspacing="1">
        			<%-- DATE --%>
			        <tr>
			            ...
			            <td class="admin2">
			                <input id="trandate" onchange="calculateToday()" type="text" class="text" size="12" maxLength="10" name="currentTransactionVO.<TransactionVO[hashCode=<bean:write name="transaction" scope="page" property="transactionId"/>]>.updateTime" value="<mxs:propertyAccessorI18N name="transaction" scope="page" property="updateTime" formatType="date" format="dd-mm-yyyy"/>">
...
<script>
  ...
  if (aFEV1Date.length>0){
    ...
    dFEV1Today = new Dot(DFEV1.ScreenX(Date.UTC(today.getFullYear(), today.getMonth()+1, today.getDate(),0,0,0,0)), DFEV1.ScreenY(document.all['MyFEV1'].value), 9, 5, "32CD32",document.all['MyFEV1'].value);
  }
  ...
  if (aFVCValue.length>0){
    ...
    var dFVCToday = new Dot(DFVC.ScreenX(Date.UTC(today.getFullYear(), today.getMonth()+1, today.getDate(),0,0,0,0)), DFVC.ScreenY(document.all['MyFVC'].value), 9, 5, "32CD32",document.all['MyFVC'].value);
  }
...
<script>document.getElementById("trandate").focus();
