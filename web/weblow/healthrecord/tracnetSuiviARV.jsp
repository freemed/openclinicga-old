...
<script>
  ...
  function submitForm(){
    ...
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI1" property="itemId"/>]>.value"].value = sSuivi.substring(0,254);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI2" property="itemId"/>]>.value"].value = sSuivi.substring(254,508);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI3" property="itemId"/>]>.value"].value = sSuivi.substring(508,762);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI4" property="itemId"/>]>.value"].value = sSuivi.substring(762,1016);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI5" property="itemId"/>]>.value"].value = sSuivi.substring(1016,1270);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI6" property="itemId"/>]>.value"].value = sSuivi.substring(1270,1524);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI7" property="itemId"/>]>.value"].value = sSuivi.substring(1524,1778);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI8" property="itemId"/>]>.value"].value = sSuivi.substring(1778,2032);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI9" property="itemId"/>]>.value"].value = sSuivi.substring(2032,2286);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUIVI10" property="itemId"/>]>.value"].value = sSuivi.substring(2286,2540);
    ...
    if (isAtLeastOneSummaryFieldFilled()) {
      ...
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER1" property="itemId"/>]>.value"].value = sSummary.substring(0,254);
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER2" property="itemId"/>]>.value"].value = sSummary.substring(254,508);
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER3" property="itemId"/>]>.value"].value = sSummary.substring(508,762);
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER4" property="itemId"/>]>.value"].value = sSummary.substring(762,1016);
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER5" property="itemId"/>]>.value"].value = sSummary.substring(1016,1270);
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER6" property="itemId"/>]>.value"].value = sSummary.substring(1270,1524);
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER7" property="itemId"/>]>.value"].value = sSummary.substring(1524,1778);
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER8" property="itemId"/>]>.value"].value = sSummary.substring(1778,2032);
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER9" property="itemId"/>]>.value"].value = sSummary.substring(2032,2286);
      document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_TRACNET_SUIVI_ARV_SUMMARY_OTHER10" property="itemId"/>]>.value"].value = sSummary.substring(2286,2540);
