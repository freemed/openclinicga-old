        ...
        <td colspan="4" width="100%">
            <table width="100%" cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="admin2">
                        <table border="0" background='<c:url value="/_img/lines.gif"/>'>
                            <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
