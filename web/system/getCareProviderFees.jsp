	...
	<%
		...
		while(rs.next()){
			...
			if(type.equalsIgnoreCase("prestation")){
				...
				out.println("<tr class='admin'><td><img src='_img/icons/icon_delete.png' onclick='deleteline(\"prestationtype\",\""+id+"\",\""+userid+"\")'/></td><td>"+a+"</td><td>"+getTran("prestation.type",id,sWebLanguage)+"</td><td>"+rs.getFloat("OC_CAREPROVIDERFEE_AMOUNT")+"%</td></tr>");
				nodata=false;
			}
				...
				out.println("<tr class='admin'><td><img src='_img/icons/icon_delete.png' onclick='deleteline(\"invoicegroup\",\""+id+"\",\""+userid+"\")'/></td><td>"+a+"</td><td>"+id+"</td><td>"+famount+"%</td></tr>");
				nodata=false;
			}
				...
				out.println("<tr class='admin'><td><img src='_img/icons/icon_delete.png' onclick='deleteline(\"default\",\""+id+"\",\""+userid+"\")'/></td><td colspan=2>"+a+"</td><td>"+famount+"%</td></tr>");
				nodata=false;
			}
		}
		rs.close();
