...
<table width="100%" class="menu" cellspacing="0" cellpadding="0">
  <%-- INPUT & BUTTONS --%>
  <tr>
    <td width="<%=sTDAdminWidth%>"> <%=getTran("Web.manage","labprofiles.cols.code",sWebLanguage)%></td>
    <td>
...
<table border="0" width="100%" class="list" cellspacing="1" cellpadding="0">
  ...
  <tr>
    ...
    <td class="admin2">
        <input type="text" name="EditProfileCode"  class="text" value="<%=sEditProfileCode%>" size="20" onblur="validateText(this);limitLength(this);">
    </td>
  </tr>
  <%-- LABEL --%>
  <%
              ...
              <td class="admin2">
                <table border="0" class="list" cellspacing="0" cellpadding="0">
                  ...
                  <tr class="list1">
                    ...
                    <td>
                      <input type="button" class="button"  name="LabChooseButton" value="<%=getTran("Web","choose",sWebLanguage)%>" onclick="searchLabAnalysis();">&nbsp;
                      <input type="button" class="button"  name="LabAddButton"    value="<%=getTran("Web","add",sWebLanguage)%>" onClick="addLabAnalysis();">
                    </td>
                  </tr>
                  <%
                      // compose search-select
