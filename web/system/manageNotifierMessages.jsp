...
<%
	...
	String start=new SimpleDateFormat("dd/MM/yyyy").format(new java.util.Date(new java.util.Date().getTime()-period));
	if(request.getParameter("submit")!=null){
		...
		while (rs.next()){
			...
			String sCreated = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").format(rs.getTimestamp("OC_NOTIFIER_CREATEDATETIME"));
