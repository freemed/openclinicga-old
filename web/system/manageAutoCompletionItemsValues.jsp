...
<form name="transactionForm" method="POST">
    ...
    <table class="list" width="100%" cellspacing="1">
        <%-- DESTINATION ITEM --%>
        <tr>
            <td class="admin" width="<%=sTDAdminWidth%>"><%=getTran("Web", "user", sWebLanguage)%>
            </td>
            <td class="admin2">
        ...
        <tr id="VALUES" style="visibility:hidden;">
            ...
            <td class="admin"><%=getTran("Web.manage", "itemValues", sWebLanguage)%>
            </td>
            <td class="admin2">
                <div id="ItemsValuesByType">
                </div>
            </td>
        </tr>
...
<script>
    ...
    function delValue(itemType, itemid, user) {
        if (itemid == "") {
            //******** if delete All Values of ITEM ******/
            var Check = confirm("Delete : " + itemType + " ?");
            if (Check == true) {
            ...
            //******** if delete value  ******/
            var Check = confirm("Delete value ?");
            if (Check == true) {
    ...
    function getValuesByItemTypeAndUser(thi) {
        //************** SET SELECT FIELD WITH ALL SELECTED ITEMS OF THIS USER ************/
