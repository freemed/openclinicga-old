    ...
    <div id="weekScheduler_container">
        ...
        <div id="weekScheduler_top">
            <div class="spacer"><span></span>
                ...
                <a class="print_user_button" href="javascript:;" onclick="printPlanning('');" title="<%=getTranNoLink("hrm.persinfo","printalltabs",sWebLanguage)%>" alt='<%=getTranNoLink("hrm.persinfo","printalltabs",sWebLanguage)%>'><img src="<c:url value="/_img/printer-print.png" />" class="link" alt="print" /></a>
                <a class="print_patient_button" href="javascript:;" onclick="printPlanning('',true);" title="<%=getTranNoLink("hrm.persinfo","printalltabs",sWebLanguage)%>" alt='<%=getTranNoLink("hrm.persinfo","printalltabs",sWebLanguage)%>'><img src="<c:url value="/_img/printer-print.png" />" class="link" alt="print" /></a>
            </div>
            <div class="days" id="weekScheduler_dayRow">
                <div id="top_day_1" class="<%=(todayNumber==1)?"today":""%>"><%=getTran("web", "monday", sWebLanguage)%> <span></span> <a class="print_user_button" title="<%=getTranNoLink("web","print",sWebLanguage)%>" href="javascript:;" onclick="printPlanning('<%=Calendar.MONDAY%>');" alt='print'><img src="<c:url value="/_img/printer-print.png" />" class="link" alt="print" style="vertical-align:-4px;"/></a></div>
                <div id="top_day_2" class="<%=(todayNumber==2)?"today":""%>"><%=getTran("web", "Tuesday", sWebLanguage)%> <span></span> <a class="print_user_button" title="<%=getTranNoLink("web","print",sWebLanguage)%>" href="javascript:;" onclick="printPlanning('<%=Calendar.TUESDAY%>');" alt='print'><img src="<c:url value="/_img/printer-print.png" />" class="link" alt="print" style="vertical-align:-4px;"/></a></div>
                <div id="top_day_3" class="<%=(todayNumber==3)?"today":""%>"><%=getTran("web", "Wednesday", sWebLanguage)%> <span></span> <a class="print_user_button" title="<%=getTranNoLink("web","print",sWebLanguage)%>" href="javascript:;" onclick="printPlanning('<%=Calendar.WEDNESDAY%>');" alt='print'><img src="<c:url value="/_img/printer-print.png" />" class="link" alt="print" style="vertical-align:-4px;"/></a></div>
                <div id="top_day_4" class="<%=(todayNumber==4)?"today":""%>"><%=getTran("web", "Thursday", sWebLanguage)%> <span></span> <a class="print_user_button" title="<%=getTranNoLink("web","print",sWebLanguage)%>" href="javascript:;" onclick="printPlanning('<%=Calendar.THURSDAY%>');" alt='print'><img src="<c:url value="/_img/printer-print.png" />" class="link" alt="print" style="vertical-align:-4px;"/></a></div>
                <div id="top_day_5" class="<%=(todayNumber==5)?"today":""%>"><%=getTran("web", "Friday", sWebLanguage)%> <span></span> <a class="print_user_button" title="<%=getTranNoLink("web","print",sWebLanguage)%>" href="javascript:;" onclick="printPlanning('<%=Calendar.FRIDAY%>');" alt='print'><img src="<c:url value="/_img/printer-print.png" />" class="link" alt="print" style="vertical-align:-4px;"/></a></div>
                <div id="top_day_6" class="<%=(todayNumber==6)?"today":""%>"><%=getTran("web", "Saturday", sWebLanguage)%> <span></span> <a class="print_user_button" title="<%=getTranNoLink("web","print",sWebLanguage)%>" class="" href="javascript:;" onclick="printPlanning('<%=Calendar.SATURDAY%>');" alt='print'><img src="<c:url value="/_img/printer-print.png" />" class="link" alt="print" style="vertical-align:-4px;"v/></a></div>
                <div id="top_day_0" class="<%=(todayNumber==7)?"today":""%>"><%=getTran("web", "Sunday", sWebLanguage)%> <span></span> <a class="print_user_button" title="<%=getTranNoLink("web","print",sWebLanguage)%>" class="" href="javascript:;" onclick="printPlanning('<%=Calendar.SUNDAY%>');" alt='print'><img src="<c:url value="/_img/printer-print.png" />" class="link" alt="print" style="vertical-align:-4px;"/></a></div>
            </div>            
        </div>
