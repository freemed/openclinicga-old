...
public class DiagnosisGraph {
	...
	public static String drawSimpleValueGraph(int serverId, String code, String sLanguage,String userid){
        ...
        try {
			...
			ps = conn.prepareStatement("select * from DC_DIAGNOSISVALUES where DC_DIAGNOSISVALUE_SERVERID=? and DC_DIAGNOSISVALUE_CODETYPE='KPGS' and DC_DIAGNOSISVALUE_CODE=? order by DC_DIAGNOSISVALUE_YEAR,DC_DIAGNOSISVALUE_MONTH");
