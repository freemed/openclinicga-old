...
public class Planning extends OC_Object {
    ...
    public void setPlannedEndDate() {
        ...
        c.setTime(this.plannedDate);
        c.add(Calendar.MINUTE, Integer.parseInt(this.getEstimatedtime().split(":")[1]));
        c.add(Calendar.HOUR, Integer.parseInt(this.getEstimatedtime().split(":")[0]));
        this.plannedEndDate = c.getTime();
    }
    ...
    public static Planning get(String uid) {
        ...
        if ((uid != null) && (uid.length() > 0)) {
            ...
            if (ids.length == 2) {
                ...
                ResultSet rs = null;
                String sSelect = "SELECT * FROM OC_PLANNING WHERE OC_PLANNING_SERVERID = ? AND OC_PLANNING_OBJECTID = ?";
                ...
                try {
                    ...
                    Debug.println("OpenPractice => Planning.java => get => " + e.getMessage());
    ...
    public static Vector getPatientMissedPlannings(String sPatientUID) {
        ...
        try {
            ...
            Debug.println("OpenClinic => Planning.java => getPatientMissedPlannings => " + e.getMessage() + " = " + sSelect);
            e.printStackTrace();
        }
        finally {
            try {
    ...
    public static boolean isAvailablePlannedDate(String sUserUID, String sPlannedDate, String sPlannedDateTime, String sPlanningUID, String sEstimatedtime) {
        ...
        try {
            ...
            Date dEnd = ScreenHelper.getSQLTime(sPlannedDate + " " + sPlannedDateTime);
            Calendar calendar;
            String[] aTime;
            int iHour, iMinute;
            ...
            Debug.println("OpenClinic => Planning.java => isAvailablePlannedDate => " + e.getMessage() + " = " + sSelect);
            e.printStackTrace();
        }
        finally {
            try {
    ...
    public static Hashtable getPlanningPermissionUsers(String sUserID) {
        String sSelect = "SELECT * FROM UserParameters WHERE parameter = 'PlanningFindUserIDs' AND value like '%;" + sUserID + "%'";
        PreparedStatement ps = null;
        ResultSet rs = null;
        ...
        try {
            ...
            Debug.println("OpenClinic => Planning.java => getPlanningPermissionUsers => " + e.getMessage() + " = " + sSelect);
            e.printStackTrace();
        }
        finally {
            try {
    ...
    public static void delete(String sPlanningUID) {
        ...
        if ((sPlanningUID != null) && (sPlanningUID.length() > 0)) {
            ...
            if (ids.length == 2) {
                PreparedStatement ps = null;
                String sSelect = "DELETE FROM OC_PLANNING WHERE OC_PLANNING_SERVERID = ? AND OC_PLANNING_OBJECTID = ?";
                try {
                    ps = oc_conn.prepareStatement(sSelect);
                    ps.setInt(1, Integer.parseInt(ids[0]));
                    ps.setInt(2, Integer.parseInt(ids[1]));
                    ...
                    Debug.println("OpenClinic => Planning.java => delete => " + e.getMessage() + " = " + sSelect);
                    e.printStackTrace();
                }
                finally {
                    try {
