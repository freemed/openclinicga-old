            ...
            while (iterator.hasNext()) {
                ...
                if (request.getParameter("be.mxs.healthrecord.updateTransaction.actionForwardKey").indexOf("be.mxs.healthrecord.transaction_id=currentTransaction")<=0){
                    ...
                    while (enumeration.hasMoreElements()){
                        ...
                        if (code.indexOf("ICPCCode")==0 || code.indexOf("GravityICPCCode")==0 || code.indexOf("CertaintyICPCCode")==0){
                    ...
                    while (enumeration.hasMoreElements()){
                        code=(String)enumeration.nextElement();
                        if (code.indexOf("ICD10Code")==0 || code.indexOf("GravityICD10Code")==0 || code.indexOf("CertaintyICD10Code")==0){
