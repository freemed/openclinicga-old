...
public class PDFWicketDebetProofGenerator extends PDFInvoiceGenerator {
    ...
    private void addHeading(WicketDebet credit) throws Exception {
        ...
        try {
            ...
            //*** title ***
            table.addCell(createTitleCell(getTran("web","wicketdebetproof").toUpperCase()+" #"+credit.getUid().split("\\.")[1]+" - "+new SimpleDateFormat("dd/MM/yyyy").format(credit.getOperationDate()),"",4));
