...
<%
	...
	while(rs.next()){
		...
		if(encounteruid!=i || !s.equalsIgnoreCase(service)){
			...
			out.println("<tr  onClick='window.location.href=\"main.do?Page=curative/index.jsp&ts="+getTs()+"&PersonID="+rs.getInt("personid")+"\";' class='list1' onmouseover=\"this.className='list_select';\" onmouseout=\"this.className='list1';\"><td>#"+i+": "+rs.getString("lastname")+" "+rs.getString("firstname")+"</td><td>"+(d==null?"":new SimpleDateFormat("dd/MM/yyyy").format(d))+"</td><td>"+
