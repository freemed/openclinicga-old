...
<% String sAction = checkString(request.getParameter("addOrDeleteValue"));
    ...
    if (sAction.equals("del")) {
        ...
        if (!sCounterEdit.equals("")) {
            ...
            out.write(getTran("Web.manage", "addNewValue", sWebLanguage) + "<script>var getValues = ajaxChangeSearchResults(\"_common/search/searchByAjax/itemsTypesShow.jsp\", transactionForm, \"&itemTypeSelect=" + sItemValue + "\", \"ItemsValuesByType\");</script>");
        } else {
            //****** IF UPDATE VALUE *******//
            medwanQuery.delAutocompletionItemsValues(sItemId, "", 0);
