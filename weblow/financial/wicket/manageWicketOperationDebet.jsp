<%@ page import="be.openclinic.finance.WicketDebet, be.openclinic.finance.Wicket,java.util.Vector" %>
...
<div id="divTodayDebets" style="width:100%;height:250px;border: 0px solid #666666;overflow:auto;"></div>
<script>
    function doFind(){
  ...
  function doSave(){
    ...
    function loadTodayDebets(){
        var params = '';
        var today = new Date();
        var url= '<c:url value="/financial/wicket/todayWicketDebets.jsp"/>?ts='+today;
