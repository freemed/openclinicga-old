...
<script>
  ...
  function editWarning(serverId,transactionId){
    window.location.href = "<c:url value='/healthrecord/editTransaction.do'/>?be.mxs.healthrecord.createTransaction.transactionType=be.mxs.common.model.vo.healthrecord.IConstants.TRANSACTION_TYPE_ALERT&ts=<%=getTs()%>&be.mxs.healthrecord.server_id="+serverId+"&be.mxs.healthrecord.transaction_id="+transactionId;
  }
</script>