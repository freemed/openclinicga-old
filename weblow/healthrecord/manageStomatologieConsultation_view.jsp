    ...
    private StringBuffer addTooth(int iTotal,String sToothNr,String sDescription,String sTreatment,String sStatus,String sWebLanguage){
        ...
        sTmp.append(
                    "<tr id='rowTooth"+iTotal+"'>" +
                        "<td class=\"admin2\">" +
                        "   <a href='#' onclick='deleteTooth(rowTooth"+iTotal+");'><img src='" + sCONTEXTPATH + "/_img/icon_delete.gif' alt='" + getTran("Web.Occup","medwan.common.delete",sWebLanguage) + "' border='0'></a> "+
                        "   <a href='#' onclick='editTooth(rowTooth"+iTotal+");'><img src='" + sCONTEXTPATH + "/_img/icon_edit.gif' alt='" + getTran("Web.Occup","medwan.common.edit",sWebLanguage) + "' border='0'></a>" +
                        "</td>" +
            ...
            <td colspan="2">
                <table cellspacing="1" cellpadding="0" width="100%" id="tblTeeth">
                    ...
                    <tr>
                        ...
                        <td class="admin2">
                            <input type="button" class="button" name="ButtonAddTooth" value="<%=getTran("Web","add",sWebLanguage)%>" onclick="addTooth();">
...
function addTooth(){
  if(isAtLeastOneToothFieldFilled() && transactionForm.toothNr.value != ""){
      ...
      td.innerHTML = "<a href='#' onclick='deleteTooth(rowTooth"+iTeethIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                    +"<a href='#' onclick='editTooth(rowTooth"+iTeethIndex+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
      tr.appendChild(td);
...
function updateTooth(){
  if(isAtLeastOneToothFieldFilled() && transactionForm.toothNr.value != ""){
    ...
    row.cells[0].innerHTML = "<a href='#' onclick='deleteTooth("+editTeethRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_delete.gif' alt='<%=getTran("Web.Occup","medwan.common.delete",sWebLanguage)%>' border='0'></a> "
                            +"<a href='#' onclick='editTooth("+editTeethRowid.id+")'><img src='<%=sCONTEXTPATH%>/_img/icon_edit.gif' alt='<%=getTran("Web.Occup","medwan.common.edit",sWebLanguage)%>' border='0'></a>";
...
function submitForm() {
    ...
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH1" property="itemId"/>]>.value"].value = sTeeth.substring(0,254);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH2" property="itemId"/>]>.value"].value = sTeeth.substring(254,508);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH3" property="itemId"/>]>.value"].value = sTeeth.substring(508,762);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH4" property="itemId"/>]>.value"].value = sTeeth.substring(762,1016);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH5" property="itemId"/>]>.value"].value = sTeeth.substring(1016,1270);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH6" property="itemId"/>]>.value"].value = sTeeth.substring(1270,1524);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH7" property="itemId"/>]>.value"].value = sTeeth.substring(1524,1778);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH8" property="itemId"/>]>.value"].value = sTeeth.substring(1778,2032);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH9" property="itemId"/>]>.value"].value = sTeeth.substring(2032,2286);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH10" property="itemId"/>]>.value"].value = sTeeth.substring(2286,2540);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH11" property="itemId"/>]>.value"].value = sTeeth.substring(2540,2794);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH12" property="itemId"/>]>.value"].value = sTeeth.substring(2794,3048);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH13" property="itemId"/>]>.value"].value = sTeeth.substring(3048,3302);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH14" property="itemId"/>]>.value"].value = sTeeth.substring(3302,3556);
    document.all["currentTransactionVO.items.<ItemVO[hashCode=<mxs:propertyAccessorI18N name="transaction.items" scope="page" compare="type=be.mxs.common.model.vo.healthrecord.IConstants.ITEM_TYPE_STOMATOLOGY_CONSULTATION_TEETH15" property="itemId"/>]>.value"].value = sTeeth.substring(3556,3810);
